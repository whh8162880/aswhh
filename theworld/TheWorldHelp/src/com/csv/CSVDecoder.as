...
//		}
		 ...
		 *   @tiptext
		 */
		public function decode(str:String) : Array
		{
			var count  : uint = 0
			var result : Array = new Array ();
			var data:Array;
			...
			for(  var i : uint = 0; i < data.length; i++ )
			{
				...
				count += scount( data[ i ] , fieldEnclosureToken )
			}
		...
		public function scount ( haystack : String, needle : String, offset : Number = 0, length : Number = 0 ) : Number
		{
			if ( length === 0 )
