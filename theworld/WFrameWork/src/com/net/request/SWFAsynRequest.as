package com.net.request
{
	...
	public class SWFAsynRequest extends BaseAsyncRequest
	{
		...
		public function SWFAsynRequest(url:String = null,value:URLVariables=null,useService:Boolean = false,targetLoader:Loader = null)
		{
			resetInfo(url,value,useService,targetLoader);
		}
		
		public function resetInfo(url:String = null,value:URLVariables=null,useService:Boolean = false,targetLoader:Loader = null):void
		{
			if(useService){
				//				url = ""
			}
