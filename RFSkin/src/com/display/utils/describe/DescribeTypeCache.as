...
{
    registerCacheHandler("variablesInfo",variablesInfoHandler);
    ...
    private static function variablesInfoHandler(record:DescribeTypeCacheRecord):*{
    	return new VariablesInfo(record.typeDescription);
    }
}
