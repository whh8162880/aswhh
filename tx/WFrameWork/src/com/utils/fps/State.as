...
//		}
		...
		private var locData:Object=SharedObject.getLocal("flashStates")
		private function init(e : Event) : void
		{
			...
			//this.x=locData.data.x
			//this.y=locData.data.y
		...
		private function onMouseDown(e:MouseEvent):void{
			if(e.type==MouseEvent.MOUSE_DOWN){
				...
				this.alpha=1
				this.stopDrag();
				locData.data.x=this.x
				locData.data.y=this.y
		...
		private function destroy(e : Event) : void
		{
			...
			removeEventListener(MouseEvent.MOUSE_UP,onMouseDown);
		}
