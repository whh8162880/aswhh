...
public class KeyStroke{
	...
	private static var keyDescriptionDict:Dictionary = new Dictionary()
	
	public static function getKeyStrokeByKeyCode(keycode:int):KeyStroke{
		return keyCodeDict[keycode];
	}
	public static function getKeyStrokeByKeyDescription(keyDescription:String):KeyStroke{
		return keyDescriptionDict[keyDescription];
	}
	...
	public function KeyStroke(description:String, code:uint){
		...
		this.code = code;
		keyCodeDict[code] = this;
		keyDescriptionDict[codeString] = this;
	}
