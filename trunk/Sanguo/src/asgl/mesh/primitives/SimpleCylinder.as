package asgl.mesh.primitives {
	...
	public class SimpleCylinder {
		public static function create(radius:Number, height:Number, heightSegs:int=1, capSegs:int=1, sides:int=3, generateUV:Boolean=true):MeshObject {
			...
			var v:Vertex3D = new Vertex3D(radius);
			...
			var unitRadius:Number = radius/capSegs;
